...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2022 at 05:55 PM
...
INSERT INTO `tb_member` (`id_member`, `username`, `password`, `firstname`, `lastname`, `department`, `role`, `email`) VALUES
...
--
ALTER TABLE `tb_member`
  MODIFY `id_member` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
COMMIT;
