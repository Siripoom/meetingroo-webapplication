                ...
                <div class="cardt rounded-0 shadow">
                            ...
                            <form action="save_schedule.php" method="post" id="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select id="room" name="room">
                                        ...
                                        <option value="โดมใหญ่">อาคารอเนกประสงค์ ชั้น3</option>
                    ...
                    <div class="card-footer">
                        <div class="text-center">
                            <button class="btn btn-primary btn-sm rounded-0" type="submit" name="submit"><i class="fa fa-save"></i> บันทึก</button>
                            <button class="btn btn-defult border btn-sm rounded-0" type="reset" form="schedule-form"><i class="fa fa-reset"></i> ยกเลิก</button>
                        </div>
                    </div>
                    </form>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0">
                <div class="modal-header rounded-0">
                    <h5 class="modal-title">วาระการประชุม</h5>
